...
public class StudentHome extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 100, 130, 30));
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/studen_rsult_management_system/Student Home.png"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            Connection con=(Connection)DriverManager.getConnection("jdbc:mysql://localhost:3306/student_rms","root","Munazir@2315");
            Statement stmt=con.createStatement();
            ResultSet rs=stmt.executeQuery("Select * from student inner join result where student.Roll='"+rollno+"' and result.rollno='"+rollno+"'");
            if(rs.next()){
                setVisible(false);
